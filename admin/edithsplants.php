...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add_prod_house_sale"  class="btn btn-primary">Add plant</button>
      </div>
      </form>
    </div>
  </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">House Plants</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <button id="Add_plant" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">On Sale House Plants</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <?php
   ...
   require_once "dbc.php";
         ...
         $sql="SELECT * FROM `prod_sch_house_sale`";
         ...
         while($row = mysqli_fetch_assoc($result)){
              ...
              <td>".$row['hps_desc']."</td>
              <td>".$row['hps_price']."</td>
              <td>".$row['hps_delprice']."</td>
              
              <form action='editprod_hsale.php' method='post'>
              ...
              <td id='gotcha'><input type='hidden' name='hps_eprod_id' value='".$row['hps_id']."' ></td>
              </form>

              <form action='Upload.php' method='post'>
              <td clsss='btn_conta'>
              <input class='btn btn-primary float-left bg-red' type='submit' name='dlt_proh_one_sale' value='Delete' onclick='return arSureOnepro()'></td>
              <td><input id='gotcha' type='hidden' name='hp_prod_id_sale' value='".$row['hps_id']."' ></td>
              </tr>
              </form>";
              $srno++;
         }
